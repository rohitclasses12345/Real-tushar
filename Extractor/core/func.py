from config import CHANNEL_ID, SUDO_USERS, FORCE_SUB
...
async def subscribe(app, message):
   ...
   if update_channel:
      try:
         ...
         await message.reply_photo(photo="https://graph.org/file/702aa31236364e4ebb2be-3f88759834a4b164a0.jpg",caption=script.FORCE_MSG.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🕹️ ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ 🕹️", url=f"{url}")]]))
         return 1
      except Exception:
